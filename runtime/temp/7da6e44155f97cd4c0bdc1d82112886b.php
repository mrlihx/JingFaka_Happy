<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/shop.paozf.com/application/templates/mobile/index/default/pay/order.html";i:1646323578;}*/ ?>
<html>
...
<body>
    ...
    <form id="payForm" name="p" action="/index/pay/payment" <?php if($isMobile == '0'): ?>target="_blank"
        <?php endif; ?>> <input type="hidden" name="trade_no" value="<?php echo htmlentities($order['trade_no']); ?>">
