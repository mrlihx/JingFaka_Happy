...
function env_check(&$env_items) {
    ...
    $env_items[] = array('name' => 'PHP版本', 'min' => '7.0', 'good' => '7.0', 'cur' => PHP_VERSION, 'status' => (PHP_VERSION < 7.0 | PHP_VERSION >= 7.1 ? 0 : 1));
    ...
    $env_items[] = array('name' => '磁盘空间', 'min' => '200M', 'good' => '>200M', 'cur' => empty($disk_place) ? '未知' : $disk_place . 'M', 'status' => $disk_place < 100 ? 0 : 1);
}
