...
class AlipayQrcode extends PayService {
    ...
    public function pay($trade_no, $subject, $totalAmount) {
        ...
        $callbackurl = url("pay/AlipayQrcode/callback");
        $notifyurl = url("pay/AlipayQrcode/notify");

        $aliPay = new AlipayQrcodeService();
        ...
        if ($result['code'] && $result['code'] == '10000') {
            return $this->qrcode($result['qr_code']);
        } else {
