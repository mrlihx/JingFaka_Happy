...
class XinXinhui extends PayService {
    ...
    public function pay($trade_no, $subject, $totalAmount) {
        ...
        $callbackurl = url("pay/XinXinhui/callback");
        $notifyurl = url("pay/XinXinhui/notify");
        ...
        $res = $this->request_post("http://www.zzhengt.com/order/pay.do", $native);
    ...
    public function refund($order) {
        ...
        $native = array(
            ...
            "bgUrl" => url("pay/XinXinhui/refundNofity"),
        ...
        $res = $this->request_post("http://www.zzhengt.com/refund/pay.do", $native);
        $res = json_decode($res, true);
        if ($res['rspCode'] == '00') {
